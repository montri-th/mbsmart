/* Presentation v13. Geometry v09-r7; v11 comment contract preserves prior pins. */
(()=>{'use strict';
 ...
 const images=[
  ...
  {id:'exterior-aerial',section:'exterior',view:'site',title:'อาคารเดิม กับบทใหม่ที่เชื่อมถึงกัน',caption:'แสงบ่ายนุ่มเชื่อมโชว์รูม ลาน และอู่กับบริบทถนน หลังคาที่จอดหลังอู่ยาวตลอดแนวอาคารประมาณ 37.98 ม. ในโมเดล เสาทุก 3 ช่องจอด ระยะ 7.50 ม. โดยคงแถวตีเส้น 10 ช่องเดิม',note:'บริบทเมืองและแสงเป็นภาพตีความ ไม่ใช่ภาพสำรวจ · 10 คันตัวอย่าง / 26 ช่องภายนอก (38.5%) รวมส่วนที่ถูกบัง · ให้ยึดผังและโมเดลสำหรับตำแหน่ง'},
 ...
 for(const item of images)item.version='v13';
 const plans=[
 ...
 function renderGallery(){
  ...
  for(const item of items){
   ...
   const downloads=kind==='plan'?[[`./assets/downloads/${item.id}-v13.png`,'ดาวน์โหลด Hi-res · PNG 4,400 px'],[`./assets/plans/${item.id}-v13.svg`,'ดาวน์โหลดเวกเตอร์ · SVG']]:[[`./assets/downloads/${item.id}-v13-hires.png`,'ดาวน์โหลด Hi-res · PNG ต้นฉบับ 1,672 × 941 px']];
