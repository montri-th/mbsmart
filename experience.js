/* Presentation v14. Geometry v09-r8; v11 comment contract preserves prior pins. */
(()=>{'use strict';
 ...
 const sections={
  ...
  workshop:{title:'อู่ซ่อม',description:'ภาพเปิดหลังคาเพื่ออ่านพื้นที่ทำงานและส่วน smart ที่เชื่อมกับอู่เดิม ตรวจรูปทรงหลังคาเต็มได้ในมุมภายนอก',views:['workshop','workshop-detail','service','workshop-plan'],areas:['general','workshop','hv','me','parts','service','other']}
 };
 const images=[
  ...
  {id:'exterior-aerial',section:'exterior',view:'site',title:'อาคารเดิม กับบทใหม่ที่เชื่อมถึงกัน',caption:'หลังคาใหญ่อู่ยื่นถึงเสาชิดรั้วริมถนน แยกจากกันสาดทางผ่านเตี้ยและหลังคาจอดหลังอู่ที่ยาวตลอดอาคาร ถนนเสม็ด–อ่างศิลาแสดง 6 เลน ไป 3 กลับ 3 ตามเจ้าของ',note:'บริบทเมืองและแสงเป็นภาพตีความ ไม่ใช่ภาพสำรวจ · ความกว้างเลน เกาะกลาง และขนาดโครงหลังคายังไม่ใช่ระยะวัดจริง · 10 คันตัวอย่าง / 26 ช่องภายนอก (38.5%) รวมส่วนที่ถูกบัง'},
 ...
 for(const item of images)item.version='v14';
 const plans=[
  ...
  {id:'groundfloor-site-plan',section:'exterior',view:'siteplan',title:'ผังชั้นล่างทั้งหมด · อาคารและ Exterior',caption:'รวมโชว์รูม อู่ และลาน 26 ช่อง: ด้านหน้าขนานถนน 5 ติดอาคาร 2 ด้านเสม็ด–อ่างศิลา 4 มุมอาคาร 1 ด้านหลัง 10 และข้างอู่ 4 ช่อง',note:'MB-S03 ภายในอยู่ข้างสำนักงาน CS แยกจาก 26 ช่องภายนอก · ระยะขอบกระบะต้นไม้ถึงด้านในรั้วหน้า 7.20 ม. ตามเจ้าของ; รัศมี R1.20 ม. เทียบภาพ ไม่ใช่รังวัด',width:2200,height:2520,highlights:['รถตัวอย่าง 10 / 26 ช่อง ≈ 40% เว้นบริเวณทางเข้าและจุดอัตลักษณ์','หลังอู่ 10 ช่อง 2.5 × 5.0 ม. เว้นผนัง 1.0 ม. ใต้หลังคาตลอดแนวอู่ · เสาทุก 3 ช่อง','B1: S-D-01 Demo · B2: S-S-01 Sales · หลังช่อง 1: S-D-02 Demo','ไม่เพิ่มต้นไม้หรือแถบปลูกตามรั้วและทางเท้า']},
 ...
 function renderGallery(){
  ...
  for(const item of items){
   ...
   const downloads=kind==='plan'?[[`./assets/downloads/${item.id}-v14.png`,'ดาวน์โหลด Hi-res · PNG 4,400 px'],[`./assets/plans/${item.id}-v14.svg`,'ดาวน์โหลดเวกเตอร์ · SVG']]:[[`./assets/downloads/${item.id}-v14-hires.png`,'ดาวน์โหลด Hi-res · PNG ต้นฉบับ 1,672 × 941 px']];
